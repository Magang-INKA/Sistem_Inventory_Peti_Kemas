            ...
            {{-- <div class="pd-20 card-box height-100-p text-center" >
                ...
                <div class="product-detail-desc pd-20 card-box height-100-p">
                    <form>
                        ...
                        <div class="form-group row" style="padding-left: 40px">
                            <label for="merk_barang" class="col-sm-10 col-md-4 col-form-label text-white">Merk Barang</label>
                            <div class="col-md-7 col-sm-12">
                        ...
                        <div class="form-group row" style="padding-left: 40px">
                            <label for="bahan" class="col-sm-10 col-md-4 col-form-label text-white">Bahan</label>
                            <div class="col-md-7 col-sm-12">
                        ...
                        <div class="form-group row" style="padding-left: 40px">
                            <label for="harga" class="col-sm-10 col-md-4 col-form-label text-white">Harga Satuan</label>
                            <div class="col-md-7 col-sm-12">
                        ...
                        <div class="form-group row" style="padding-left: 40px">
                            <label for="tgl_input" class="col-sm-10 col-md-4 col-form-label text-white">Tanggal Beli</label>
                            <div class="col-md-7 col-sm-12">
