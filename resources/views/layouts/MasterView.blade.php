...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{asset('template/src/plugins/datatables/css/dataTables.bootstrap4.min.css')}}">
	<link rel="stylesheet" type="text/css" href="{{asset('template/src/plugins/datatables/css/responsive.bootstrap4.min.css')}}">
...
<body>
    ...
    <script src="{{asset('template/src/plugins/apexcharts/apexcharts.min.js')}}"></script>
	<script src="{{asset('template/src/plugins/datatables/js/jquery.dataTables.min.js')}}"></script>
	<script src="{{asset('template/src/plugins/datatables/js/dataTables.bootstrap4.min.js')}}"></script>
	<script src="{{asset('template/src/plugins/datatables/js/dataTables.responsive.min.js')}}"></script>
	<script src="{{asset('template/src/plugins/datatables/js/responsive.bootstrap4.min.js')}}"></script>
	...
	{{--  <script src="{{asset('template/vendors/scripts/datatable-setting.js')}}"></script></body>  --}}
</body>
</html>
