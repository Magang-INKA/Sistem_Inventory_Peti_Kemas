...
<div class="pd-20 card-box mb-30">
    ...
    @endif
	<form method="POST" action="{{ route('trip.update' , $trip->id) }}" id="myForm" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="form row">
            ...
            <div class="col-sm-12 col-md-10">
                <div class="input-group">
                    ...
                    <input id="asal_pelabuhan_id" type="hidden" name="asal_pelabuhan_id" value="{{ $trip->asal_pelabuhan_id }}" required readonly="">
        ...
        <div class="form row">
            ...
            <div class="col-sm-12 col-md-10">
                <div class="input-group">
                    ...
                    <input id="final_pelabuhan_id" type="hidden" name="final_pelabuhan_id" value="{{ $trip->final_pelabuhan_id }}" required readonly="">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-md-10">
                <div class="input-group">
                    ...
                    <input id="id_kapal" type="text" class="form-control" name="id_kapal" value="{{ $trip->kapal->no_kapal }}" required readonly="">
