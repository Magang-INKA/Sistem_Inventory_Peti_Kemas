...
<div class="pd-20 card-box mb-30">
    ...
    @endif
	<form method="POST" action="{{ route('kapal.update', $kapal->id) }}" id="myForm" enctype="multipart/form-data">
        @csrf
        @method('PUT')
		<div class="form-group row">
			<label for="nama_kapal" class="col-sm-12 col-md-2 col-form-label text-white">Nama Kapal</label>
			<div class="col-sm-12 col-md-10">
				<input class="form-control" type="text" name="nama_kapal" id="nama_kapal"
                value="{{ $kapal->nama_kapal }}" aria-describedby="nama_kapal" placeholder="">
			</div>
		</div>
        <div class="form row">
            ...
            <div class="col-sm-12 col-md-10">
                <div class="input-group">
                    <input id="nama_pelabuhan1" type="text" class="form-control" readonly="" value="{{ $kapal->pelabuhan->nama_pelabuhan }}" required>
        ...
        <div class="form row">
            ...
            <div class="col-sm-12 col-md-10">
                <div class="input-group">
                    <input id="nama_pelabuhan2" type="text" class="form-control" readonly="" value="{{ $kapal->tujuan->nama_pelabuhan }}" required>
                    <input id="id_tujuan" type="hidden" name="id_tujuan" value="{{ $kapal->pelabuhan->nama_pelabuhan }}" required readonly="">
		...
		<div class="form-group row">
			...
			<div class="col-sm-12 col-md-10">
                ...
                value="{{ $kapal->jadwal }}" aria-describedby="jadwal" placeholder="">
			</div>
		</div>
		<div class="form-group row">
